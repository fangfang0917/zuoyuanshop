<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\user\index.html";i:1576464408;s:76:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\base.html";i:1488899632;s:87:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\javascript_vars.html";i:1488899632;s:72:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\user\form.html";i:1576464408;s:70:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\user\th.html";i:1576464408;s:70:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\user\td.html";i:1576464408;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="用户名" name="username" value="<?php echo \think\Request::instance()->param('username'); ?>" >
    <input type="text" class="input-text" style="width:250px" placeholder="积分" name="amount" value="<?php echo \think\Request::instance()->param('amount'); ?>" >
    <input type="text" class="input-text Wdate" style="width:250px" placeholder="最后登陆时间" name="lastlogintime" value="<?php echo \think\Request::instance()->param('lastlogintime'); ?>"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  >
    <input type="text" class="input-text Wdate" style="width:250px" placeholder="注册时间" name="createTime" value="<?php echo \think\Request::instance()->param('createTime'); ?>"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  >
...
<th width="">用户名</th>
<th width=""><?php echo sort_by('积分','amount'); ?></th>
<th width="">最后登陆时间</th>
<th width=""><?php echo sort_by('注册时间','createTime'); ?></th>
            <th width="70">操作</th>
        </tr>
        </thead>
        <tbody>
...
<td><?php echo high_light($vo['amount'],\think\Request::instance()->param('amount')); ?></td>
