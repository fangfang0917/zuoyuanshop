<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\goods_attr\add.html";i:1576636636;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
//                    key=$(lv1Arr[j]).attr('data-id');
        ...
        function save_attr() {
            ...
            $.ajax({
                'url':'<?php echo url("goods_Attr/save_attr"); ?>',
                'method':'post',
