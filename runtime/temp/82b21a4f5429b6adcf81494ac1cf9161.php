<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\attr_val\edit.html";i:1576652468;s:76:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\base.html";i:1576807343;s:87:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\javascript_vars.html";i:1488899632;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <input type="hidden" name="attr_key_id" value="<?php if(isset($vo)): ?><?php echo $vo['attr_key_id']; else: ?><?php echo $kid; endif; ?>">
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>规格属性名称：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="规格属性名称" name="name" value="<?php echo isset($vo['name']) ? $vo['name'] :  ''; ?>"  datatype="*" nullmsg="请填写规格属性名称">
            </div>
