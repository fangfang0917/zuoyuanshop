<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\goods\edit.html";i:1576894455;s:76:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\base.html";i:1576807343;s:87:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\javascript_vars.html";i:1488899632;s:75:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\pos.html";i:1576895638;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="col-xs-3 col-sm-3"></div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="点击添加规格" onclick="getattr(this)" readonly id="cid" data-cid="<?php echo isset($vo['cid']) ? $vo['cid'] :  ''; ?>">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
...
<script>
    ...
    function getattr(even) {
        ...
        console.log(cid);
        layer_open('添加规格',"<?php echo url('goods/getattr'); ?>?cid="+cid);
    }
