<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:87:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\one\two\three\four\index.html";i:1577958447;s:76:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\base.html";i:1577958449;s:87:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\javascript_vars.html";i:1577958449;s:86:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\one\two\three\four\form.html";i:1577958447;s:84:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\one\two\three\four\th.html";i:1577958447;s:84:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\one\two\three\four\td.html";i:1577958447;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<td><?php echo get_status($vo['status']); ?></td>
            <td class="f-14">
                <?php echo show_status($vo['status'],$vo['id']); if (\Rbac::AccessCheck('edit')) : ?> <a title="编辑" href="javascript:;" class="label label-success radius  ml-5" onclick="layer_open('编辑','<?php echo \think\Url::build('edit', ['id' => $vo["id"], ]); ?>')" style="text-decoration:none">编辑</a><?php endif; if (\Rbac::AccessCheck('delete')) : ?> <a title="删除" href="javascript:;"  class="label label-warning radius  ml-5" onclick="del(this,'<?php echo $vo['id']; ?>','<?php echo \think\Url::build('delete', []); ?>')"  style="text-decoration:none">删除</a><?php endif; ?>
            </td>
        </tr>
