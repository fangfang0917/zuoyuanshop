<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\dissystem\sys_order\edit.html";i:1578035712;s:76:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\base.html";i:1577958449;s:87:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\javascript_vars.html";i:1577958449;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="用户" readonly name="userId" value="<?php echo gettableval('user','realname',$vo['userId']); ?>" >
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="提交人" readonly name="name" value="<?php echo isset($vo['name']) ? $vo['name'] :  ''; ?>" >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="提交人联系方式" readonly name="phone" value="<?php echo isset($vo['phone']) ? $vo['phone'] :  ''; ?>" >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="房屋面积" readonly name="mm" value="<?php echo isset($vo['mm']) ? $vo['mm'] :  ''; ?>" >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="备注" name="remarks" value="<?php echo isset($vo['remarks']) ? $vo['remarks'] :  ''; ?>" >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6 skin-minimal">
                <?php if(is_array(\think\Config::get('conf.systype')) || \think\Config::get('conf.systype') instanceof \think\Collection || \think\Config::get('conf.systype') instanceof \think\Paginator): if( count(\think\Config::get('conf.systype'))==0 ) : echo "" ;else: foreach(\think\Config::get('conf.systype') as $k=>$v): ?>
                <div class="radio-box">
                    <input type="radio" name="type" id="radio-<?php echo $k; ?>" <?php if(isset($vo)): if($vo['type'] == $k): ?> checked <?php endif; endif; ?> value="<?php echo $k; ?>">
