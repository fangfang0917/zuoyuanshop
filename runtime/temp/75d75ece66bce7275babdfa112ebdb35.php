...
<div class="page-container">
    ...
    <div class="select-box" style="width:250px">
        <?php echo GetGoodsC(\think\Request::instance()->param('id')); ?>
    </div>
    <div class="select-box" style="width:250px">
        <?php echo GetPos(\think\Request::instance()->param('id')); ?>
    </div>
    <input type="text" class="input-text" style="width:250px" placeholder="商品名" name="name" value="<?php echo \think\Request::instance()->param('name'); ?>" >
    <input type="text" class="input-text" style="width:250px" placeholder="积分" name="int" value="<?php echo \think\Request::instance()->param('int'); ?>" >
    <input type="text" class="input-text" style="width:250px" placeholder="库存" name="stock" value="<?php echo \think\Request::instance()->param('stock'); ?>" >
...
<th width="">缩略图</th>
<th width="">描述</th>
<th width=""><?php echo sort_by('积分','int'); ?></th>
<th width="">创建时间</th>
<th width=""><?php echo sort_by('库存','stock'); ?></th>
            <th width="70">操作</th>
        </tr>
        </thead>
        <tbody>
...
<td><?php echo high_light($vo['int'],\think\Request::instance()->param('int')); ?></td>
<td><?php echo tt($vo['createtime'],'Y-m-d'); ?></td>
<td><?php echo high_light($vo['stock'],\think\Request::instance()->param('stock')); ?></td>
            <td class="f-14">
...
<script>
    $(function () {
        $("[name='cid']").find("[value='<?php echo \think\Request::instance()->param('cid'); ?>']").attr("selected", true);
    })
</script>
