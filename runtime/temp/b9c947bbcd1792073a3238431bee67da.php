<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:77:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\attr_key\index.html";i:1576651450;s:76:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\base.html";i:1488899632;s:87:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\template\javascript_vars.html";i:1488899632;s:76:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\attr_key\form.html";i:1576650696;s:74:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\attr_key\th.html";i:1576650513;s:74:"D:\phpstudy_pro\WWW\shop\public/../application/admin\view\attr_key\td.html";i:1576650696;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="id" name="attr_key_id" value="<?php echo \think\Request::instance()->param('attr_key_id'); ?>" >
    <div class="select-box" style="width: 250px">
        <?php echo GetGoodsC(\think\Request::instance()->param('cid')); ?>
    </div>
    <input type="text" class="input-text" style="width:250px" placeholder="规格名称" name="name" value="<?php echo \think\Request::instance()->param('name'); ?>" >
...
<th width="100">id</th>
<th width="100"><?php echo sort_by('商品分类','cid'); ?></th>
...
<td><?php echo high_light($vo['name'],\think\Request::instance()->param('name')); ?></td>
            <td class="f-14">
                ...
                <a href="javascript:layer_open('添加规格属性','<?php echo url('AttrVal/index'); ?>?kid=<?php echo $vo['id']; ?>')">查看属性</a>
            </td>
        </tr>
